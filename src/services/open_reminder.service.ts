...
@injectable()
export default class OpenReminderService {
    ...
    public async listReminders(
        ...
        const searchQuery = OpenReminderService.buildSearchQuery(search);
    ...
    private async getQueriedIntervalReminders(
        ...
        if (queryStartDate && queryEndDate) {
            queriedReminders = queriedReminders.filter((reminder) => (
                OpenReminderService.isIntervalInRange(
                    reminder.createdAt,
    ...
    private async getQueriedDayOfTheWeekReminders(
        ...
        const queryDays = OpenReminderService.getDaysBetween(queryStartDate, queryEndDate);
